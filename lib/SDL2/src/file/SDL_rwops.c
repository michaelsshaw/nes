...
static size_t SDLCALL
cpu_read(SDL_RWops * context, void *ptr, size_t size, size_t maxnum)
{
    size_t total_bytes;
...
static size_t SDLCALL
cpu_write(SDL_RWops * context, const void *ptr, size_t size, size_t num)
{
...
static size_t SDLCALL
cpu_writeconst(SDL_RWops * context, const void *ptr, size_t size, size_t num)
{
